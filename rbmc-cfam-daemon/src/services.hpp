...
class Services
{
  public:
     ...
     * @param stateCallback - Function to run when the BMC state changes
     * @param roleCallback - Function to run when the role changes
     * @param redEnabledCallback - Function to run when the redundancyEnabled
     *                             prop changes
     */
     ...
     */
    static std::string getVersionID(const std::filesystem::path& file);
